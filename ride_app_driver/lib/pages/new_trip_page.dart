...
import 'package:ride_app_driver/widgets/payment_dialog.dart';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  obtainDirectionAndDrawRoute(sourceLocationLatLng, destinationLocationLatLng) async{
    ...
    if(sourceLocationLatLng.latitide > destinationLocationLatLng.latitude && sourceLocationLatLng.longitude > destinationLocationLatLng.longitude){
      boundsLatLng = LatLngBounds(southwest: destinationLocationLatLng, northeast: sourceLocationLatLng);
    }
    else if(sourceLocationLatLng.longitude > destinationLocationLatLng.longitude){
      boundsLatLng = LatLngBounds(southwest: LatLng(sourceLocationLatLng.latitude, destinationLocationLatLng.longitude), northeast: LatLng(destinationLocationLatLng.latitude, sourceLocationLatLng.longitude),);
    }
    else if(sourceLocationLatLng.latitide > destinationLocationLatLng.latitude){
      boundsLatLng = LatLngBounds(southwest: LatLng(destinationLocationLatLng.latitude, sourceLocationLatLng.longitude), northeast: LatLng(sourceLocationLatLng.latitude, destinationLocationLatLng.longitude),);
    }
    else{
      boundsLatLng = LatLngBounds(southwest: sourceLocationLatLng, northeast: destinationLocationLatLng);
    }
    ...
    Circle sourceCircle = Circle(
      circleId: CircleId("sourceCircleID"),
  ...
  endTripNow() async {
    ...
    var directionDetailsEndTripInfo = await CommonMethods.getDirectionDetailsFromAPI(widget.newTripDetailsInfo!.pickUpLatLng!, driverCurrentLocationLatLng,);
        ...
        children: [
          ...
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController googleMapController) async{
              ...
              setState(() {
                googleMapPaddingFromBottom = 260;
              });
          ...
          Positioned(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.black26, blurRadius: 17, spreadRadius: 0.5, offset: Offset(0.7, 0.7),),
                ],
              ),
              height: 282,
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    /** trip duration **/
                    Center(
                      child: Text("$durationText - $distanceText", style: TextStyle(color: Colors.green, fontSize: 15, fontWeight: FontWeight.bold,),),
                    ),
                    SizedBox(height: 5,),
                    ...
                    Row(
                      ...
                      children: [
                        /** username **/
                        Text(widget.newTripDetailsInfo!.userName!, style: TextStyle(color: Colors.green, fontSize: 20, fontWeight: FontWeight.bold,),),
                        /** call user icon button **/
                        GestureDetector(
                          onTap: (){
                            launchUrl(Uri.parse("tel://${widget.newTripDetailsInfo!.userPhone}"));
                          },
                          child: Padding(
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(widget.newTripDetailsInfo!.pickUpAddress.toString(), overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 18, color: Colors.grey,),),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(widget.newTripDetailsInfo!.dropOffAddress.toString(), overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 18, color: Colors.grey,),),
                            ),
                          ],
                        ),
                        ...
                        Center(
                          child: ElevatedButton(
                            ...
                            child: Text(buttonTitleText, style: TextStyle(color: Colors.white,),),
                          ),
                        ),
                      ],
                    ),
